<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
        <a href="<?= base_url() ?>" class="navbar-brand">
            <img src="<?= base_url() ?>assets/profil/logo-teha.jpg" alt=" AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">Teha Olshop</span>
        </a>
            ...
            <li class="nav-item">
                <?php if ($this->session->userdata('email') == "") { ?>
                    <a class="nav-link" href="<?= base_url('pelanggan/login') ?>">
                        ...
                        <img src="<?= base_url() ?>assets/profil/logo-admin.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    </a>
                <?php } else { ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="<?= base_url('pelanggan/logout') ?>" class="dropdown-item dropdown-footer">
                            <i class="fas fa fa-power-off mr-2"></i> Log out
                        </a>
                    </div>
                <?php } ?>
            </li>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Teha Olshop</a></li>
