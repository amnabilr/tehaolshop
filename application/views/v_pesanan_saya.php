                             ...
                             <table class="table">
                                 ...
                                 <?php foreach ($diproses as $key => $value) { ?>
                                     <tr>
                                         ...
                                         <td>
                                             <b>Rp. <?= number_format($value->total_bayar, 0) ?></b><br>
                                             <span class="badge badge-success">Terverikasi</span><br>
                             ...
                             <table class="table">
                                 ...
                                 <?php foreach ($dikirim as $key => $value) { ?>
                                     <tr>
                                         ...
                                         <td>
                                             <h5><?= $value->no_resi ?><br>
                                                 <button href="" data-toggle="modal" data-target="#diterima<?= $value->id_transaksi ?>" class="btn btn-primary btn-xs btn-flat">Diterima</button>
                                             </h5>
                                         </td>
                                     </tr>
                                 <?php } ?>
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     Apakah Pesanan Anda Sudah Diterima ... ?
                 </div>
